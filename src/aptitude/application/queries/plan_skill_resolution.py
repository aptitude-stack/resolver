...
from aptitude.discovery import (
...
from aptitude.domain.models import DiscoveryCandidate, ResolutionGraph
from aptitude.domain.policy import (
    PolicyContext,
    PolicyEvaluation,
...
from aptitude.execution import ExecutionPlan, build_execution_plan
from aptitude.governance import (
    evaluate_resolution_graph,
    filter_policy_compliant_candidates,
)
from aptitude.lockfile import Lockfile, build_lockfile
from aptitude.resolution.graph import resolve_recursive_graph
from aptitude.resolution.solver import (
...
from aptitude.telemetry import TelemetryCollector, emit_stage_timings
