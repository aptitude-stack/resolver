...
from aptitude_resolver.application.use_cases.inspect_skill import InspectSkillUseCase
...
from aptitude_resolver.application.use_cases.search_skills import SearchSkillsUseCase
