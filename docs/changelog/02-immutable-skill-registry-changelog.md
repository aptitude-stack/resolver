...
- Relationship fields are present in milestone 02 manifests even before client orchestration logic, reducing migration churn for milestones 03 and 06 ([manifest schema](/Users/yonatan/Dev/aptitude-server/app/interface/api/skills.py), [manifest validation tests](/Users/yonatan/Dev/aptitude-server/tests/unit/test_skill_manifest.py)).
