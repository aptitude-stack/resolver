...
3. [mcp-interface.md](mcp-interface.md) when the change touches MCP tools, resources, prompts, transport, or output formatting
4. [server-resolver-boundary.md](server-resolver-boundary.md)
5. [decision-rules.md](decision-rules.md)
6. [selection-and-governance.md](selection-and-governance.md) when the change touches discovery, ranking, policy, governance, lockfiles, or checksums
...
- `mcp-interface.md` defines the current local MCP server contract.
